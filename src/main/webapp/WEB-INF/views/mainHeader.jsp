...
<body>
	...
	<div align="center" class="title">
		...
		<c:if test="${not empty id }">
			<a href="logout.do">
				<button type="button" class="btn btn-default btn-sm" id="center">로그아웃</button></a>
			<a href="gmMypage.do">
				<button type="button" class="btn btn-default btn-sm" id="center">마이페이지</button></a>
				<p><h5 class="text-primary">${id }님 환영합니다 !</h5>
		</c:if>
		<hr>
	</div>
	<!-- 	</div> -->
