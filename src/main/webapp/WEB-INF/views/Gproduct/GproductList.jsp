	...
	<table class="table table-hover">
		...
		<c:forEach var="list" items="${list }">
			<tr>
				...
				<td><img src="images/${list.pro_image }" width="30" height="30"></td>	
				<td>${list.pro_date }</td>
				<td>${list.pro_count }</td>	
				<td>${list.pro_sell }</td>
				<td>
					<a href="GproductUpdateForm.do?pro_num=${list.pro_num }"><button type="button" class="btn btn-default">수정</button></a>
					<a href="GproductDelete.do?pro_num=${list.pro_num}"><button type="button" class="btn btn-default" onclick="return delchk()">삭제</button></a>
				</td>
			</tr>		
		</c:forEach>	
	</table>
